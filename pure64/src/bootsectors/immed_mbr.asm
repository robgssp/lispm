...
;
; In this code we are expecting code directly after the MBR (512 bytes
; from the start). A small check is made to make sure Pure64 was loaded
; by comparing a signiture.
; =============================================================================
...
;	xchg bx, bx			; Bochs magic debug
	...
	mov ebx, 1			; Start immediately after directory (offset 8192)
